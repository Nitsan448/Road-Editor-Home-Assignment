...
public class RoadEditorManager : RoadEditorManager_Base
{
    ...
    [SerializeField] private ARoadEditorManagerInputHandler _roadEditorManagerInputHandler;
    ...
    public override bool Init()
    {
        ...
        _roadEditorManagerInputHandler.Init(_mouseRayCastsManager, _roadEditor, _roadCostCalculator);
        return true;
    }
    ...
    private void Update()
    {
        ...
        _roadEditorManagerInputHandler.ReactToInput();
    }
